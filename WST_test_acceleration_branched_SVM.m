...
legend("Average Training Accuracy","Average Validation Accuracy","C = 750",'Location','southeast')
title('Support Vector Machine Trained with Acceleration Data WST','Branched Water Network','FontWeight','bold')
% Additional settings if required
ax = gcf;
exportgraphics(ax,'SVM_branched_acceleration_WST.png')
%%
%%
...
title('Test ROC Curves of SVM for the Acceleration Data', 'Branched Water Network','FontWeight','bold')
legend('Location', 'Best', 'FontSize', 8)
grid on 
ax = gcf;
exportgraphics(ax,'SVM_branched_acceleration_WST_ROCS.png')
%%
