...
title('K-Nearest Neighbors Trained with Hydrophone Data WST','Branched Water Network','FontWeight','bold')
% Additional settings if required
ax = gcf;
exportgraphics(ax,'KNN_branched_hydrophone_WST.png')
%%
%%
...
title('Test ROC Curves of KNN for the Hydrophone Data', 'Branched Water Network','FontWeight','bold')
legend('Location', 'Best', 'FontSize', 8)
grid on 
ax = gcf;
exportgraphics(ax,'KNN_branched_hydrophone_WST_ROCS.png')
%%
