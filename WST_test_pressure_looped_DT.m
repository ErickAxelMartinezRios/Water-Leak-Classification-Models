...
title('Decision Tree Trained with Dynamic Pressure Data WST','Looped Water Network','FontWeight','bold')
% Additional settings if required
ax = gcf;
exportgraphics(ax,'DT_looped_pressure_WST.png')
%%
...
title('Test ROC Curves of DT for the Dynamic Pressure Data', 'Looped Water Network','FontWeight','bold')
legend('Location', 'Best', 'FontSize', 8)
grid on 
ax = gcf;
exportgraphics(ax,'DT_looped_pressure_WST_ROCS.png')
%%
