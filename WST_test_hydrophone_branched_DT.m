...
legend("Average Training Accuracy","Average Validation Accuracy","Leaf Size = 1",'Location','southeast')
title('Decision Tree Trained with Acceleration Data WST','Branched Water Network','FontWeight','bold')
% Additional settings if required
ax = gcf;
exportgraphics(ax,'DT_branched_acceleration_WST.png')
%%
%%
...
plot(rocmetrics(yTest_h_branched,probs_final_branched,mdl_final_branched.ClassNames),'LineWidth',3,'ShowModelOperatingPoint',false)
ylabel('True Positive Rate','FontWeight','bold')
xlabel('False Positive Rate','FontWeight','bold')
title('Test ROC Curves of DT for the Acceleration Data', 'Branched Water Network','FontWeight','bold')
legend('Location', 'Best', 'FontSize', 8)
grid on 
ax = gcf;
exportgraphics(ax,'DT_branched_hydrophone_WST_ROCS.png')
%%
