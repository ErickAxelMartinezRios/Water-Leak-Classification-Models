...
ylabel('Hydrophone (V)', 'FontWeight', 'bold');
...
grid on 
title('Hydrophone data WST coefficients for the Branched Water Network')
ax = gca;
exportgraphics(ax,'WST_coefficients_leak_branched_hydrophone.png')
...
legend("Average Training Accuracy","Average Validation Accuracy","C = 50",'Location','southeast')
title('Support Vector Machine Trained with Hydrophone Data WST','Branched Water Network','FontWeight','bold')
% Additional settings if required
ax = gcf;
exportgraphics(ax,'SVM_branched_hydrophone_WST.png')
%%
%%
...
title('Test ROC Curves of SVM for the Hydrophone Data', 'Branched Water Network','FontWeight','bold')
legend('Location', 'Best', 'FontSize', 8)
grid on 
ax = gcf;
exportgraphics(ax,'SVM_branched_hydrophone_WST_ROCS.png')
%%
