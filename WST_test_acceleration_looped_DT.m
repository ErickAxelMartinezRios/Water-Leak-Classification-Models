...
legend("Average Training Accuracy","Average Validation Accuracy","Leaf Size = 2",'Location','best')
title('Decision Tree Trained with Acceleration Data WST','Looped Water Network','FontWeight','bold')
% Additional settings if required
ax = gcf;
exportgraphics(ax,'DT_looped_acceleration_WST.png')
%%
...
title('Test ROC Curves of DT for the Acceleration Data', 'Looped Water Network','FontWeight','bold')
legend('Location', 'Best', 'FontSize', 8)
grid on 
ax = gcf;
exportgraphics(ax,'DT_looped_acceleration_WST_ROCS.png')
%%
