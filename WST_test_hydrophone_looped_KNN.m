...
title('K-Nearest Neighbors Trained with Hydrophone Data WST','Looped Water Network','FontWeight','bold')
% Additional settings if required
ax = gcf;
exportgraphics(ax,'KNN_looped_hydrophone_WST.png')
%%
...
confmat_final__looped = confusionmat(yTest_h_looped,YPred_final_looped,'Order', ...
    {'Circumferential Crack','Gasket Leak','Longitudinal Crack','No-leak','Orifice Leak'});
...
title('Test ROC Curves of KNN for the Hydrophone Data', 'Looped Water Network','FontWeight','bold')
legend('Location', 'Best', 'FontSize', 7)
grid on 
ax = gcf;
exportgraphics(ax,'KNN_looped_hydrophone_WST_ROCS.png')
%%
...
titleText = sprintf('Test Results of the KNN for the Hydrophone Data\nfor the Looped Water Network');
cm.Title = titleText;
