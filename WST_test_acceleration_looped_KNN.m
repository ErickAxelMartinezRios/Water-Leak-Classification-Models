...
legend("Average Training Accuracy","Average Validation Accuracy","N = 4",'Location','northeast')
title('K-Nearest Neighbors Trained with Acceleration Data WST','Looped Water Network','FontWeight','bold')
% Additional settings if required
ax = gcf;
exportgraphics(ax,'KNN_looped_acceleration_WST.png')
%%
...
title('Test ROC Curves of KNN for the Acceleration Data', 'Looped Water Network','FontWeight','bold')
legend('Location', 'Best', 'FontSize', 7)
grid on 
ax = gcf;
exportgraphics(ax,'KNN_looped_acceleration_WST_ROCS.png')
%%
...
titleText = sprintf('Test Results of the KNN for the Acceleration Data\nfor the Looped Water Network');
cm.Title = titleText;
