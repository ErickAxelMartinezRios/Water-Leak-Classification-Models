...
legend("Average Training Accuracy","Average Validation Accuracy","Leaf Size = 9",'Location','best')
title('Decision Tree Trained with Hydrophone Data WST','Branched Water Network','FontWeight','bold')
% Additional settings if required
ax = gcf;
exportgraphics(ax,'DT_branched_hydrophone_WST.png')
%%
%%
...
xlabel('True Positive Rate','FontWeight','bold')
ylabel('False Positive Rate','FontWeight','bold')
title('Test ROC Curves of DT for the Hydrophone Data', 'Branched Water Network','FontWeight','bold')
