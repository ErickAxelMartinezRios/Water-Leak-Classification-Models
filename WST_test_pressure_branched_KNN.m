...
legend("Average Training Accuracy","Average Validation Accuracy","N = 3",'Location','southeast','Location','best')
title('K-Nearest Neighbors Trained with Dynamic Pressure Data WST','Branched Water Network','FontWeight','bold')
% Additional settings if required
ax = gcf;
exportgraphics(ax,'KNN_branched_pressure_WST.png')
%%
%%
...
title('Test ROC Curves of KNN for the Dynamic Pressure Data', 'Branched Water Network','FontWeight','bold')
legend('Location', 'Best', 'FontSize', 8)
grid on 
ax = gcf;
exportgraphics(ax,'KNN_branched_pressure_WST_ROCS.png')
%%
