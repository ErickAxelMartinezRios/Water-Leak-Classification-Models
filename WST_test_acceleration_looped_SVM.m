...
grid on 
title('Acceleration data WST coefficients for the Looped Water Network')
ax = gca;
exportgraphics(ax,'WST_coefficients_leak_looped.png')
...
legend("Average Training Accuracy","Average Validation Accuracy","C = 100",'Location','southeast')
title('Support Vector Machine Trained with Acceleration Data WST','Looped Water Network','FontWeight','bold')
% Additional settings if required
ax = gcf;
exportgraphics(ax,'SVM_looped_acceleration_WST.png')
%%
...
title('Test ROC Curves of SVM for the Acceleration Data', 'Looped Water Network','FontWeight','bold')
legend('Location', 'Best', 'FontSize', 8)
grid on 
ax = gcf;
exportgraphics(ax,'SVM_looped_acceleration_WST_ROCS.png')
%%
